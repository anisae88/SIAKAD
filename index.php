<?php
// index.php (Di folder ROOT proyek SIAKAD)
...
/*
* Logika Pengecekan Level (Mahasiswa/Dosen/Admin) DIHAPUS.
* Jika pengguna sudah lolos pengecekan di atas (sudah login), 
* mereka akan LANGSUNG melihat konten HTML template di bawah.
*/
...
<html lang="en">
  ...
  <head>
    ...
    <meta name="title" content="SIAKAD | Sistem Akademik" />
  ...
  <body class="sidebar-expand-lg sidebar-open bg-body-tertiary">
    ...
    <div class="app-wrapper">
              ...
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  <p>
                    ...
                    <small>Member since Nov. 2028</small>
                  </p>
                </li>
                <!--end::User Image-->
                <!--begin::Menu Body-->
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="./?p=alumni" class="nav-link">
                  <i class="nav-icon bi bi-circle-fill"></i>
                  <p>Alumni</p>
                </a>
              <li class="nav-item">
                <a href="./?p=ganti_passwoard" class="nav-link">
                  <i class="nav-icon bi bi-circle-fill"></i>
                  <p>Ganti Passwoard</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./?p=add_mahasiswa" class="nav-link">
                  <i class="nav-icon bi bi-circle-fill"></i>
      ...
      <!--begin::App Main-->
    <?php
      require_once "assets/admin/root.php";
    ?>
      <!--end::App Main-->
      <!--begin::Footer-->
      <footer class="app-footer">
        ...
        <strong>
          ...
          <a href="https://adminlte.io" class="text-decoration-none">by.Me</a>.
        </strong>
        All rights reserved.
        <!--end::Copyright-->
      </footer>
